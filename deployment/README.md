...
```
npm run deploy:deployer:Supernets2:goerli
npm run verify:deployer:Supernets2:goerli
```
...
```
npm run deploy:testnet:Supernets2:goerli
...
```
npm run verify:Supernets2:goerli
```

...
npx hardhat run deployment/2_deploySupernets2dot0Deployer.js --network localhost
...
sudo docker build -t hermeznetwork/geth-supernets2.0-contracts -f docker/Dockerfile.geth .
